...
shinyServer(function(input, output) {
    ...
    observeEvent(input$plot_help, {
        showModal(modalDialog(
            ...
            paste("On the left, you can choose which type of plot to create.",
                  ...
                  "show another variable using color or faceting, and whether",
    ...
    observeEvent(input$regression_help, {
        showModal(modalDialog(
            ...
            br(),
            br(),
            paste("On the left, you can select a variable to predict, as well",
                  "as which variables to use as predictors. If no predictors",
                  "are selected, only an intercept term is included."),
            br(),
            br(),
