...
- Tab 1: Data Overview
    - Shows a table of up to 100 observations from the dataset. The user can select how many to display and which variable to order the dataset by.
...
- Tab 3: Linear Regression
    - Allows the user to fit linear regression models to the data, selecting which variable to predict and which to use as predictors
